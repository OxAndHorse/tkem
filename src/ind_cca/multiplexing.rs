...
use instantiations::avx2::{
    ...
    kyber_decapsulate_with_tag as kyber_decapsulate_with_tag_avx2, kyber_encapsulate_with_tag as kyber_encapsulate_with_tag_avx2,
...
use instantiations::neon::{
    ...
    kyber_decapsulate_with_tag as kyber_decapsulate_with_tag_neon, kyber_encapsulate_with_tag as kyber_encapsulate_with_tag_neon,
...
>(
    ...
    if libcrux_platform::simd256_support() {
        kyber_encapsulate_with_tag_avx2::<
            K,
            CIPHERTEXT_SIZE,
            PUBLIC_KEY_SIZE,
            T_AS_NTT_ENCODED_SIZE,
        ...
        kyber_encapsulate_with_tag_neon::<
            K,
            CIPHERTEXT_SIZE,
            PUBLIC_KEY_SIZE,
            T_AS_NTT_ENCODED_SIZE,
        ...
        instantiations::portable::kyber_encapsulate_with_tag::<
            K,
            CIPHERTEXT_SIZE,
            PUBLIC_KEY_SIZE,
            T_AS_NTT_ENCODED_SIZE,
...
#[cfg(feature = "kyber")]
pub(crate) fn kyber_decapsulate_with_tag<
    const K: usize,
    const SECRET_KEY_SIZE: usize,
    const CPA_SECRET_KEY_SIZE: usize,
    const PUBLIC_KEY_SIZE: usize,
...
>(
    ...
    if libcrux_platform::simd256_support() {
        kyber_decapsulate_with_tag_avx2::<
            K,
            SECRET_KEY_SIZE,
            CPA_SECRET_KEY_SIZE,
            PUBLIC_KEY_SIZE,
        ...
        kyber_decapsulate_with_tag_neon::<
            K,
            SECRET_KEY_SIZE,
            CPA_SECRET_KEY_SIZE,
            PUBLIC_KEY_SIZE,
        ...
        instantiations::portable::kyber_decapsulate_with_tag::<
            K,
            SECRET_KEY_SIZE,
            CPA_SECRET_KEY_SIZE,
            PUBLIC_KEY_SIZE,
